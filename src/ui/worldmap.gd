...
func _on_swe_pressed() -> void :
	...
	get_tree().change_scene_to_file("res://assets/scenes/maps/sweden.tscn")

func _on_ire_pressed() -> void :
	$Worldmap / Uirelease.play()
	get_tree().change_scene_to_file("res://assets/scenes/maps/environment2.tscn")


func _on_egy_pressed() -> void :
	$Worldmap / Uirelease.play()
	get_tree().change_scene_to_file("res://assets/scenes/maps/egypt.tscn")
...
func _on_return_2_pressed() -> void :
	$Worldmap / Uirelease.play()
	get_tree().change_scene_to_file("res://assets/scenes/trophyroom.tscn")
